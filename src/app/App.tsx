...
export default function App() {
  const handleWhatsApp = () => {
    window.open('https://wa.me/5219999999999?text=Hola,%20me%20interesa%20conocer%20más%20sobre%20la%20Logia%20Galileo%20Nº%203', '_blank');
  };

  const handleFacebook = () => {
    window.open('https://www.facebook.com/LogiaGalileo3', '_blank');
  };
